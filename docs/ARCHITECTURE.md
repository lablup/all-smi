...
# Intel Level Zero (Sysman) backend. Off by default on Linux; build.rs
# forces the equivalent `all_smi_level_zero` cfg on for Windows targets.
level_zero = []
```
